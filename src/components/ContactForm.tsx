	...
	return (
		...
		>
			...
			<div className="h-5/6">
				...
				>
					<input
						className="px-1 font-display  h-9 outline-none border border-[#c4c4c4] bg-transparent rounded-lg text-black"
						type="text"
						name="name"
						placeholder="Name"
						required
					...
					/>
					<button
						className="bg-[#EA3656] w-max mx-auto px-10 py-2 rounded-xl text-[#F1F8F7] font-display font-black"
						type="submit"
					>
						SUBMIT
					</button>

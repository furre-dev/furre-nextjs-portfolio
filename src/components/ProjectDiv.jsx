				...
				>
					...
					text-6xl"
						>
							{title}
							<span
								className="w-full absolute left-0 -z-10 text-[#EA3656]
						...
						<p className="text-[#c5c5c5] font-body font-light">{text}</p>
					</div>
					<div
						className="sm:space-x-10
					space-x-4"
					>
						<button
							className="bg-[#EA3656] text-[#F1F8F7] rounded-2xl sm:w-36 w-28 h-10 text-xs font-display font-black

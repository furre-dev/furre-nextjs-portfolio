		...
		<>
			<main className="w-full lg:max-w-7xl px-4 mx-auto">
				<div className="flex justify-center items-center h-4/5">
					<div
						className="2xl:my-24 lg:my-0 w-full flex
      md:flex-row md:pb-0
      pb-24
      flex-col "
					>
        ...
        justify-center mt-10"
						>
							...
							>
								...
								2000, I grew up in Huddinge but recently took the plunge and
								moved to Haninge. <br />
								<br />
								...
								Photoshop, Figma, After Effects, and Cinema 4D. I dabbled in
								HTML and CSS out of sheer curiosity, but my passion for web
								development only truly sparked when my sister sent me a link to
								the Front-end Development program by Chasacademy. And now, here
								I am, fully immersed and loving every minute of it! <br />
								<br />
